...
exports.showArticles = function(req, res, next) {
    ...
    let count = viewPage;
    let getTotalPageAsync = Promise.promisify(Article.getTotalPage);
    let getArticlesByLimitAsync = Promise.promisify(Article.getArticlesByLimit);
    let pager;
    ...
    //一页显示多少条
    //显示哪些
    //select * from articles limit offset,count 获取第一条到第五条
};
